...
@SourceType(value = "DynamicsCRMARP", label = "DynamicsCRM",uiConfig = "dynamicscrm-layout.json")
public class DynamicsCRMConf extends AbstractArpConf<DynamicsCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/dynamicscrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dynamicscrm.DynamicsCRMDriver";
